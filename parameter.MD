...
| cdnUrl              | ` String`                | `ALL`         | https://cdn.jsdelivr.net/npm/@mediapipe/face_mesh/                                                                                                           | 否                                                  | 初始化的时候，去cdn缓存插件地址，如果出现丢包的情况，建议将地址更换为自己服务器的地址或者自己其他的存储地址，主要是5个文件：'face_mesh.binarypb','face_mesh_solution_packed_assets.data','face_mesh_solution_packed_assets_loader.js','face_mesh_solution_simd_wasm_bin.js','face_mesh_solution_simd_wasm_bin.wasm'                                                                                               |
